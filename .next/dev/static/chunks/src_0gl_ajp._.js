...
function getChapterMasteryPercent(subtopicsByTrack, chapterStats) {
    const nodes = Object.entries(subtopicsByTrack).flatMap(([trackType, subtopics])=>subtopics.map((subtopic)=>chapterStats[(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHeatmapNodeKey"])(trackType, subtopic)] ?? chapterStats[subtopic]));
...
function Home() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            ...
            const timeoutId = window.setTimeout({
                "Home.useEffect.timeoutId": ()=>setActiveToast(null)
            }["Home.useEffect.timeoutId"], 4200);
            return ({
                "Home.useEffect": ()=>window.clearTimeout(timeoutId)
            })["Home.useEffect"];
        }
    }["Home.useEffect"], [
        activeToast
        ...
        "Home.useMemo[chapterRows]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHAPTERS_REGISTRY"].map({
                "Home.useMemo[chapterRows]": (chapter)=>{
                    const questionSubtopics = Array.from(new Set(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bank$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTION_BANK"].filter({
                        "Home.useMemo[chapterRows].questionSubtopics": (question)=>question.chapter === chapter.id || question.chapterId === chapter.id
    ...
    const sortedChapterRows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[sortedChapterRows]": ()=>{
            return [
                ...chapterRows
            ].sort({
                "Home.useMemo[sortedChapterRows]": (chapterA, chapterB)=>{
                    const chapterAMetrics = profile?.syllabusHeatmap?.[chapterA.id] ?? {};
                    const chapterBMetrics = profile?.syllabusHeatmap?.[chapterB.id] ?? {};
                    const lastTestedA = Object.values(chapterAMetrics).reduce({
                        "Home.useMemo[sortedChapterRows].lastTestedA": (latest, node)=>node.lastTested > latest ? node.lastTested : latest
                    }["Home.useMemo[sortedChapterRows].lastTestedA"], "");
                    const lastTestedB = Object.values(chapterBMetrics).reduce({
                        "Home.useMemo[sortedChapterRows].lastTestedB": (latest, node)=>node.lastTested > latest ? node.lastTested : latest
                    }["Home.useMemo[sortedChapterRows].lastTestedB"], "");
    ...
    function handleDeletePastRecordLog(submissionIdToWipe) {
        ...
        if (profileRaw) {
            ...
            const rebuiltProfile = nextRecords.filter((record)=>Boolean(record.chapterId && record.responses)).sort((recordA, recordB)=>new Date(recordA.submittedAt).getTime() - new Date(recordB.submittedAt).getTime()).reduce((currentProfile, record)=>{
                ...
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$profile$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateStudentProfileMetrics"])(activeStudentSession, archivedReport, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bank$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTION_BANK"]);
            }, emptyProfile);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
                ...
                children: [
                    ...
                    !studentName ? /* 📭 PROFILE SIGN IN INPUT STATE FORM CARD */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            activeProfileTab === "HEATMAP" ? hasSufficientTelemetry ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: visibleChapterRows.map((chapter)=>{
                                            ...
                                            const availableQuestionsCount = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bank$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTION_BANK"].filter((question)=>(question.chapterId === chapter.id || question.chapter === chapter.id) && Boolean(question.trackType && trackTypes.includes(question.trackType))).length;
                                                ...
                                                children: [
                                                    ...
                                                    isExpanded && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: trackTypes.map((trackKey)=>{
                                                            ...
                                                            const availableQuestionsCount = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$bank$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QUESTION_BANK"].filter((question)=>(question.chapterId === chapter.id || question.chapter === chapter.id) && question.trackType === trackKey).length;
            ...
            profile && hasSufficientTelemetry && profile.identifiedWeakPoints.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Home, "gN6UO3cEh03ilbMGllK/oURd+/E=");
_c = Home;
var _c;
...
function FilterPanel({ activeFilters, onUpdateFilters, onGenerate, hideAnswerKeyUntilSubmit, setHideAnswerKeyUntilSubmit, clearActiveToast, loading }) {
    ...
    const filteredChaptersList = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CHAPTERS_REGISTRY"].filter((ch)=>{
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            activeFilters.preparationLevel === "FOUNDATION" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                value: "Biology",
                                children: "🧬 Biology"
                            }, void 0, false, {
                                fileName: "[project]/src/components/FilterPanel.tsx",
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                        ...
                        children: [
                            ...
                            filteredChaptersList.map((ch)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                    value: ch.id,
                                    children: ch.title
                                }, ch.id, false, {
                                    fileName: "[project]/src/components/FilterPanel.tsx",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$chapters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/chapters.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jury$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/jury.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function WorksheetPreview({ worksheet, studentId, hideAnswerKeyUntilSubmit, hasSubmittedCurrentWorksheet, activeToast, onCloseToast, worksheetId, filters, onSubmitEvaluation }) {
    ...
    const [hasSubmittedLocally, setHasSubmittedLocally] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [ventureName, setVentureName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [executiveSummaryText, setExecutiveSummaryText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [technicalArchitectureSpecs, setTechnicalArchitectureSpecs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [ventureReport, setVentureReport] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    function submitVentureCanvas() {
        ...
        setVentureReport((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jury$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateVentureProject"])(submission));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            worksheet.title && worksheet.title !== `Class ${chosenGrade} ${chosenSubject} Worksheet` && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            isFutureTechLab ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
            ...
            isFutureTechLab && ventureReport && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        ...
                                        children: ventureReport.criticalTechnicalFlaws.map((flaw)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: flaw
                                            }, flaw, false, {
                                                fileName: "[project]/src/components/WorksheetPreview.tsx",
                                                lineNumber: 453,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        ...
                                        children: ventureReport.suggestedAdvancementsMilestones.map((milestone)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                children: milestone
                                            }, milestone, false, {
                                                fileName: "[project]/src/components/WorksheetPreview.tsx",
                                                lineNumber: 459,
            ...
            !isFutureTechLab && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(WorksheetPreview, "ka0crwzwxTjgv4oz+p661P/lgzI=");
_c = WorksheetPreview;
var _c;
...
"[project]/src/lib/jury.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_0gl_ajp._.js.map