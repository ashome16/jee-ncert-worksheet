        ...
        <section className="grid gap-6 lg:grid-cols-[300px_1fr]">
          ...
          <div className="space-y-6">
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className={`rounded-2xl border p-5 ${waiver.kind === "NONE" ? "border-zinc-200 bg-white" : "border-emerald-100 bg-emerald-50"}`}><p className="text-[10px] font-bold uppercase tracking-wider text-emerald-700">Possible fee remission</p><p className="mt-2 text-2xl font-black">{waiver.percentage}%</p><p className="mt-1 text-xs text-emerald-700">{waiver.label}</p></div>
            </div>
